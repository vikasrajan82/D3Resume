...
function displayProjectDetailsInOverLay(d) {
...
function drawEmploymentArea(svg, cy) {
    ...
    svg.selectAll("path.employmentDt")
        ...
        .append("path")
        .on("click", function (d) {
            displayProjectDetailsInOverLay(d);
        })
        .attr("fill", function (d) {
            return d.color;
        })
    ...
    svg.selectAll("line.employmentDt")
        ...
        .attr("x1", function (d, i) {
            ...
            svg.append("circle")
                ...
                .on("click", function () { displayProjectDetailsInOverLay(d); })
                .transition()
                .delay((i + 2) * 700)
                .duration(500)
                .attr("r", titleCircle);
    ...
    d3.selectAll("circle.jobDescription")
        .append("title")
        .text("Click for further details");

    d3.selectAll("text.jobDescription")
        .append("title")
        .text("Click for further details");
